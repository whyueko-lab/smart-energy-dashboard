...
# Pastikan df_log sudah terdefinisi sebelum digunakan
...
st.metric("💰 Estimasi Biaya/Jam", f"Rp {biaya:,.0f}")
...
if not df_log.empty:
    ...
    st.metric("📊 Rata-rata Total Energi dari Log", f"{rata_rata_daya:.1f} W")
...
# Grafik Bulanan
st.markdown("### 📅 **Konsumsi Energi Bulanan (Simulasi)**")
