...
# ------------------- FOOTER -------------------
st.markdown("---")
st.markdown("Made with ❤️ by [Wahyu Eko Suroso]")
st.markdown("Data dihasilkan secara acak untuk tujuan demonstrasi. Model ini tidak digunakan untuk prediksi nyata.")
