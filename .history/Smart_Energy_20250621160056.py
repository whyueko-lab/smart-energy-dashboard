...
for jam in jam_list:
    suhu = 30 - (5 * jam / 23)  # dari 30 ke 25 secara linier
...
fig_prediksi = px.scatter(
    ...
    size=[10]*24,
    color="Suhu (°C)",
    title="Prediksi Energi Tiap Jam Berdasarkan Suhu Dinamis (30°C → 25°C)",
    labels={"Daya Prediksi (W)": "Energi (W)", "Jam": "Jam (0-23)"}
)
