...
ac_status = "ON" if model_ac.predict(input_data)[0] else "OFF"
tv_status = "ON" if model_tv.predict(input_data)[0] else "OFF"
lampu_status = "ON" if model_lampu.predict(input_data)[0] else "OFF"
...
df_per_jam = df_log.drop_duplicates("Waktu Jam", keep="last")
...
# Footer
st.caption("© 2025 - Smart Energy Monitoring by Wahyu Eko Suroso + AI")
