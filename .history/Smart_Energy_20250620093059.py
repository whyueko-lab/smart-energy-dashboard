...
daya_lampu = 550 if lampu_status == "ON" else 0
daya_lain = random.uniform(5, 15)
daya_total = daya_ac + daya_tv + daya_lampu + daya_lain
kwh = daya_total / 1000
tarif = 5000   # Tarif per kWh
if hari_libur:
    tarif *= 0.8  # Diskon 20% pada hari libur
biaya = kwh * tarif
...
# Footer
st.caption("© 2025 - Smart Energy Monitoring by Wahyu Eko Suroso. Universitas Dian Nusantara. All rights reserved.")